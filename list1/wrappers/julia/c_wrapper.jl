...
function rec_factorial_wrapper(n::UInt64)::UInt64
  func = dlsym(library, "rec_factorial") # importing function
  result::Int64 = ccall(func, UInt64, (UInt64,), n) # calling the imported function, ccall(function, return type, (argument types), arguments...)
...
function gcd_wrapper(a::UInt64, b::UInt64)::UInt64
  func = dlsym(library, "gcd") # importing function
  result::Int64 = ccall(func, UInt64, (UInt64, UInt64), a, b) # calling the imported function, ccall(function, return type, (argument types), arguments...)

  return result;
end

function rec_gcd_wrapper(a::UInt64, b::UInt64)::UInt64
  func = dlsym(library, "rec_gcd") # importing function
  result::Int64 = ccall(func, UInt64, (UInt64, UInt64), a, b) # calling the imported function, ccall(function, return type, (argument types), arguments...)
...
function diophantine_equation_wrapper(a::Int64, b::Int64, c::Int64)::Tuple{Int64, Int64}
  func = dlsym(library, "diophantine_equation") # importing function
  d::Ref{Int64} = 0
  e::Ref{Int64} = 0
  ccall(func, Cvoid, (Int64, Int64, Int64, Ref{Int64}, Ref{Int64}), a, b, c, d, e) # calling the imported function, ccall(function, return type, (argument types), arguments...)
...
function rec_diophantine_equation_wrapper(a::Int64, b::Int64, c::Int64)::Tuple{Int64, Int64}
  ...
  func = dlsym(library, "rec_diophantine_equation") # importing function
  d::Ref{Int64} = 0
  e::Ref{Int64} = 0
  ccall(func, Cvoid, (Int64, Int64, Int64, Ref{Int64}, Ref{Int64}), a, b, c, d, e) # calling the imported function, ccall(function, return type, (argument types), arguments...)
